...
public class vreserva {
    ...
    public vreserva(int idreserva, int idhabitacion, int idcliente, int idtrabajador, String tipo_reserva, Date fecha_reserva, Date fecha_ingresa, Date decha_salida, Double costo_alojamiento, String estado) {
        ...
        this.decha_salida = decha_salida;
    ...
    public Date getDecha_salida() {
        return decha_salida;
    }

    public void setDecha_salida(Date decha_salida) {
        this.decha_salida = decha_salida;
    }
    ...
    public void setFecha_salida(Date date) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
